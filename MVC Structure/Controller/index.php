  ...
  <body>
        ...
        <div class="slider">
          <div id="owl-demo" class="owl-carousel owl-theme">
            <div class="item it2"><img src="../View/image/black-friday-shopping-at-the-mall_1542817198181_421713_ver1.0_62844402_ver1.0_1280_720_1.jpg" alt="">
               <h2 data-aos="fade-up">Be SAFE from COVID-19<br>Be SMART & INFORM yourself about it<br>Be KIND & SUPPORT one another</h2>
            ...
            <div class="item it4"><img src="../View/image/Best-Shopping-Destinations-of-Punjab.png" alt="">
               <h2 data-aos="fade-up">PUJAR SHOPPING <br> Sarees, Jewellery, Dhuti<br>Time to show off your best ethnic outfits</h2>
            ...
            <div class="item it3"><img src="../View/image/photo-1512365640355-6801d6e082d7.jpg" alt="">
               <h2 data-aos="fade-up">When the going gets tough<br> the tough go<br> online shopping</h2>
    ...
    <div id="abt" class="about">
        <div class="writing">
          ...
          <h2 data-aos="fade-right" data-aos-duration="3000"> Buy only because something excites you, not just for the simple act of shopping..<h1>-Karl Lagerfeld</h1></h2>
        </div>
      ...
      <div class="contact">
        <h1>Get In Touch</h1>
          ...
          <div class="col-md-6 contact-info" data-aos="fade-down" data-aos-duration="2000">
            ...
            <div class="folow">
              <b>Phone:</b><i class="fa fa-phone"></i> +880 1861367135
            </div>
          <div class="folow">
            <b>Email:</b><i class="fa fa-envelope-o"></i> taosifshaad000@gmail.com
          </div>
        </div>
    </section>
    <section id="foot">
